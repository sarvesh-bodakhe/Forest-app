...
////        Log.d(TAG, "onUserLeaveHint: WE Are Leaving");
////        super.onUserLeaveHint();
////    }
//
    public void verifyCancel() {
        Log.d(TAG, "verifyCancel: ");
...
//               cancelTimer();
    ...
    public void onBackPressed() {
        Log.d(TAG, "onBackPressed: In Main");
        if (drawer.isDrawerOpen(GravityCompat.START)){
            drawer.closeDrawer(GravityCompat.START);
        }else{
            if(HomeFragment.myTimerRunning){
                Log.d(TAG, "In Main Timer IS Running");
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                builder.setTitle("Your Tree will die if you quit");
...
//                        verifyCancel();;
                ...
                Log.d(TAG, "Timer Is not runnung");
            }
            super.onBackPressed();
        }
